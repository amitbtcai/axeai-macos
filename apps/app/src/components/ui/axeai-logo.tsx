...
const WORDMARK_PATHS = [
  ...
  "M487.316 128H470.742L457.093 92.5091H398.792L385.143 128H368.764L418.876 0H437.399L487.316 128ZM404.447 77.9636H451.438L427.845 14.9333L404.447 77.9636Z",
  "M523.223 0V128H507.625V0H523.223Z",
] as const;

export function AxeAiLogoMark(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 197 168" fill="none" {...props}>
      {MARK_PATHS.map((path) => (
...
export function AxeAiLogoLockup(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 714 128" fill="none" {...props}>
