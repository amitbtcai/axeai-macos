...
export const nativeThemes: Record<BuiltInThemeId, NativeThemeModes> = {
  catppuccin: {
    light: {
      ...
      background: "#eff1f5",
      border: "#cecfd7",
      borderHairline: "#cecfd7",
      borderSeam: "#cecfd7",
      borderSeamVertical: "#cecfd7",
      canvas: "#eff1f5",
      card: "#eff1f5",
      cardForeground: "#37394f",
      destructive: "#d20f39",
      ...
      input: "#b5b6c1",
      muted: "#dadae1",
      mutedForeground: "#4a4d61",
      pillForeground: "#37394f",
      pillIcon: "#37394f",
      pillSurfaceBorder: "#cecfd7",
      pillSurfaceSelectedBorder: "#c9cad3",
      popover: "#eff1f5",
      popoverForeground: "#37394f",
      prMerged: "#8839ef",
      primary: "#8839ef",
      primaryForeground: "#eff1f5",
      readbackForeground: "#5b5d71",
      resourceSourceShelfCardHoverBorder: "#c0c1cb",
      ring: "#8839ef",
      secondary: "#e0e0e7",
      secondaryForeground: "#37394f",
      shadowColor: "rgba(51, 51, 51, 0.1)",
      sidebar: "#ececf1",
      sidebarAccent: "#e0e0e7",
      sidebarAccentForeground: "#37394f",
      sidebarBorder: "#cecfd7",
      sidebarForeground: "#37394f",
      sidebarRing: "#8839ef",
      sidebarSearchMatch: "#ece4d1",
      sidebarSearchMatchBorder: "#eadbb8",
      stateActive: "rgba(55, 57, 79, 0.118)",
      stateHover: "rgba(55, 57, 79, 0.059)",
      subtleForeground: "#6d6f81",
      success: "#40a02b",
      successForeground: "#006981",
      surfaceAttention: "rgba(254, 100, 11, 0.14)",
      surfaceDestructive: "rgba(210, 15, 57, 0.06)",
      surfaceDestructiveBorder: "rgba(210, 15, 57, 0.25)",
      surfaceGrouped: "#e7e9ee",
      surfaceGroupedCell: "#eff1f5",
      surfaceRaised: "rgba(55, 57, 79, 0.025)",
      surfaceRaisedSolid: "#eaecf1",
      surfaceRecessed: "rgba(55, 57, 79, 0.05)",
      surfaceRecessedSoftSolid: "#e7e8ed",
      surfaceRecessedSolid: "#e7e9ee",
  ...
  gruvbox: {
    ...
    dark: {
      ...
      background: "#282828",
      border: "#68665a",
      borderHairline: "#68665a",
      borderSeam: "#68665a",
      borderSeamVertical: "#68665a",
      canvas: "#282828",
      card: "#282828",
      ...
      input: "#757163",
      muted: "#646256",
      mutedForeground: "#dfd6b2",
      pillForeground: "#fbf1c7",
      pillIcon: "#fbf1c7",
      pillSurfaceBorder: "#68665a",
      pillSurfaceSelectedBorder: "#57554c",
      popover: "#282828",
      popoverForeground: "#fbf1c7",
      prMerged: "#d3869b",
      primary: "#83a598",
      primaryForeground: "#282828",
      readbackForeground: "#c8c0a1",
      resourceSourceShelfCardHoverBorder: "#605e53",
      ring: "#83a598",
      secondary: "#5e5c52",
      secondaryForeground: "#fbf1c7",
      shadowColor: "rgba(0, 0, 0, 0.4)",
      sidebar: "#525048",
      sidebarAccent: "#5e5c52",
      sidebarAccentForeground: "#fbf1c7",
      sidebarBorder: "#68665a",
      sidebarForeground: "#fbf1c7",
      sidebarRing: "#83a598",
      sidebarSearchMatch: "#494233",
      sidebarSearchMatchBorder: "#5f5439",
      stateActive: "rgba(251, 241, 199, 0.225)",
      stateHover: "rgba(251, 241, 199, 0.138)",
      subtleForeground: "#b1ab90",
      success: "#b8bb26",
      successForeground: "#e0d787",
      ...
      surfaceGroupedCell: "#525048",
      surfaceRaised: "rgba(251, 241, 199, 0.11)",
      surfaceRaisedSolid: "#525048",
      surfaceRecessed: "rgba(251, 241, 199, 0.11)",
      surfaceRecessedSoftSolid: "#4d4b44",
      surfaceRecessedSolid: "#525048",
  ...
  nord: {
    ...
    dark: {
      ...
      background: "#2e3440",
      border: "#696e79",
      borderHairline: "#696e79",
      borderSeam: "#696e79",
      borderSeamVertical: "#696e79",
      canvas: "#2e3440",
      card: "#2e3440",
      ...
      input: "#747983",
      muted: "#656a75",
      mutedForeground: "#d3d6dc",
      pillForeground: "#eceff4",
      pillIcon: "#eceff4",
      pillSurfaceBorder: "#696e79",
      pillSurfaceSelectedBorder: "#595e69",
      popover: "#2e3440",
      popoverForeground: "#eceff4",
      prMerged: "#b48ead",
      primary: "#88c0d0",
      primaryForeground: "#2e3440",
      readbackForeground: "#bec2c9",
      resourceSourceShelfCardHoverBorder: "#616772",
      ring: "#88c0d0",
      secondary: "#606570",
      secondaryForeground: "#eceff4",
      shadowColor: "rgba(0, 0, 0, 0.4)",
      sidebar: "#545a65",
      sidebarAccent: "#606570",
      sidebarAccentForeground: "#eceff4",
      sidebarBorder: "#696e79",
      sidebarForeground: "#eceff4",
      sidebarRing: "#88c0d0",
      sidebarSearchMatch: "#4e4d48",
      sidebarSearchMatchBorder: "#645e4c",
      stateActive: "rgba(236, 239, 244, 0.225)",
      stateHover: "rgba(236, 239, 244, 0.138)",
      subtleForeground: "#aaaeb6",
      success: "#a3be8c",
      successForeground: "#cbd9c0",
      ...
      surfaceGroupedCell: "#545a65",
      surfaceRaised: "rgba(236, 239, 244, 0.11)",
      surfaceRaisedSolid: "#545a65",
      surfaceRecessed: "rgba(236, 239, 244, 0.11)",
      surfaceRecessedSoftSolid: "#505561",
      surfaceRecessedSolid: "#545a65",
  ...
  solarized: {
    ...
    dark: {
      ...
      background: "#073642",
      border: "#4e7168",
      borderHairline: "#4e7168",
      borderSeam: "#4e7168",
      borderSeamVertical: "#4e7168",
      canvas: "#073642",
      card: "#073642",
      ...
      input: "#5c7c6f",
      muted: "#4a6e66",
      mutedForeground: "#d1d1bc",
      pillForeground: "#eee8d5",
      pillIcon: "#eee8d5",
      pillSurfaceBorder: "#4e7168",
      pillSurfaceSelectedBorder: "#3b625e",
      popover: "#073642",
      popoverForeground: "#eee8d5",
      prMerged: "#6c71c4",
      primary: "#268bd2",
      primaryForeground: "#002b36",
      readbackForeground: "#b9bfa9",
      resourceSourceShelfCardHoverBorder: "#456a64",
      ring: "#268bd2",
      secondary: "#436962",
      secondaryForeground: "#eee8d5",
      shadowColor: "rgba(0, 0, 0, 0.4)",
      sidebar: "#355e5b",
      sidebarAccent: "#436962",
      sidebarAccentForeground: "#eee8d5",
      sidebarBorder: "#4e7168",
      sidebarForeground: "#eee8d5",
      sidebarRing: "#268bd2",
      sidebarSearchMatch: "#374f4a",
      sidebarSearchMatchBorder: "#51604f",
      stateActive: "rgba(238, 232, 213, 0.225)",
      stateHover: "rgba(238, 232, 213, 0.138)",
      subtleForeground: "#a0ad97",
      success: "#859900",
      successForeground: "#c7c183",
      surfaceAttention: "rgba(181, 137, 0, 0.12)",
      surfaceDestructive: "rgba(220, 50, 47, 0.08)",
      surfaceDestructiveBorder: "rgba(220, 50, 47, 0.3)",
      surfaceGrouped: "#073642",
      surfaceGroupedCell: "#3d5b61",
      surfaceRaised: "rgba(238, 232, 213, 0.11)",
      surfaceRaisedSolid: "#3d5b61",
      surfaceRecessed: "rgba(238, 232, 213, 0.11)",
      surfaceRecessedSoftSolid: "#2f5958",
      surfaceRecessedSolid: "#3d5b61",
      surfaceScrim: "rgba(7, 54, 66, 0.92)",
      surfaceSelected: "rgba(38, 139, 210, 0.12)",
      surfaceSelectedBorder: "rgba(38, 139, 210, 0.35)",
      timelineAccent: "#2aa198",
      versionUpgrade: "#e4e0cc",
      warning: "#cb4b16",
      warningText: "#e07a4e",
    },
  },
