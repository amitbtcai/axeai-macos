...
description: Submit a bb plugin to the Axe AI Community marketplace. Use this whenever a user asks to submit, list, publish, or add a plugin to the BB marketplace, or asks for a marketplace pull request. This skill checks the plugin, prepares a Git tag or npm release, creates a complete entry and icon, validates the marketplace, and opens the pull request.
---

# Submit a plugin

Submit a public plugin to the Axe AI Community marketplace through a pull request.
