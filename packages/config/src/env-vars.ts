...
// AxeAI does not send analytics until an AxeAI-owned ingestion key is
// deliberately configured. The inherited BB_* names remain wire-compatible
// internal configuration knobs.
